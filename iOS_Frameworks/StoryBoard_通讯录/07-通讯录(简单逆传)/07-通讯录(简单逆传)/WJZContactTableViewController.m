...
- (void)setAccountName:(NSString *)accountName{
    ...
    NSString *title = [NSString stringWithFormat:@"%@的通讯录",accountName];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    WJZAddContactViewController *addContactViewController = segue.destinationViewController;
    addContactViewController.contactTableViewController = self;
}

- (void)setContactItem:(WJZContactItem *)contactItem{
    _contactItem = contactItem;
    NSLog(@"%@",contactItem.name);
}
