...
int main(int argc, const char * argv[]) {
    ...
    // 利用日历类从当前时间对象中获取 年月日时分秒(单独获取出来)   \
        ...
        一般情况下如果一个方法接收一个参数, 这个参数是一个枚举 , 那么可以通过|符号, 连接多个枚举值
    ...
    NSDateComponents *cmps2 = [calendar components:type fromDate:date toDate:now options:0];
    NSLog(@"%ld年%ld月%ld日%ld小时%ld分钟%ld秒钟",
          cmps2.year, cmps2.month, cmps2.day, cmps2.hour, cmps2.minute, cmps2.second);
